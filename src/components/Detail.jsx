...
export default function Detail(props) {
  return (
    <div className='h-screen w-full fixed flex justify-center items-center bg-cyan-900 bg-opacity-50 z-10 left-0 top-0'>
      <div className='bg-[#f4f4f4] rounded-xl w-1/2 h-[80%] max-h-[80%] px-5 pb-5'>
        ...
        <div className='max-h-[300px] overflow-hidden'>
          <img src={`https://cdn2.thecatapi.com/images/${props.imageName}.jpg`} alt={props.altName} className='rounded-tr-xl rounded-bl-xl h-full w-full overflow-hidden' />
        </div>
